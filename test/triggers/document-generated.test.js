...
describe('Triggers::DocumentGenerated', () => {
  ...
  describe('performList', () => {
    describe('when only the Workspace is specified', () => {
      it('returns a list of Documents', (done) => {
        ...
        appTester(App.triggers.documentGenerated.operation.performList, bundle)
          .then((response) => {
  ...
  describe('subscribeHook', () => {
    it('creates a webhook subscription', (done) => {
      ...
      appTester(App.triggers.documentGenerated.operation.performSubscribe, bundle)
        .then((response) => {
  ...
  describe('unsubscribeHook', () => {
    it('deletes a webhook subscription', (done) => {
      ...
      appTester(App.triggers.documentGenerated.operation.performUnsubscribe, bundle)
        .then((response) => {
